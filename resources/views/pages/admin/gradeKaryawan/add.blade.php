...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <form method="post" action="{{ url('gradeKryawan/post') }}">      
                @csrf
                {{-- @csrf_fields --}}
                <div class="row form-group">
                    <div class="col-6">
                        <label for="exampleFormControlSelect1">Pilih Np</label>
                        <select class="form-control id_karyawan" id="id_karyawan" name="id_karyawan">
                              <option value="0" selected>== Pilih NP ==</option>
                    ...
                    <div class="col-6">
                        ...
                        <select class="form-control" id="namaKaryawan" name="nama_karyawan">
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <option value="0">== Pilih Unit kerja ==</option>
                         ...
                         @if($errors->has('id_unitKerja'))
                        <div class="text-danger">{{ $errors->first('id_unitKerja')}}</div>
                        @endif
                    </div>
                    ...
                    <div class="col-3">        
                        ...
                        <input type="text" name="no" class="form-control" id="no" placeholder="No Sertifikasi "  value="">
                         @if($errors->has('no'))
                ...
                <div class="row form-group">
                     <div class="col-2">
                        ...
                        <input type="text" name="nilai_kedisiplinan" class="form-control" id="nilai_kedisiplinan" placeholder="Masukan Nilai kedisiplinan"  value="">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" name="keterangan_hukuman" class="form-control" id="nilai_kepatuhan" placeholder="Nilai keterangan hukuman"  value="">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="nilai_kepatuhan" class="form-control" id="nilai_kepatuhan" placeholder="Nilai Kepatuhan"  value="">
                ...
                <div class="row form-group">
                     <div class="col-6">
                        ...
                        <input type="text" name="nilai_sikapKerja" class="form-control" id="nilai_sikapKerja" placeholder="Masukan Nilai siap kerja"  value="">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="nilai_inisiatif" class="form-control" id="nilai_inisiatif" placeholder="Nilai inisiatif"  value="">
...
@push('addon-script')
   <script type="text/javascript">
    ...
    <script>
        $('.addNki').on('click', function(){
            AddNki();
        });

        function AddNki() {
         var nki = '<div class="col-3"><label for="exampleFormControlSelect1">Tahun NKI</label><select class="form-control" id="exampleFormControlSelect1" name="Tahun[]">  <option value="">== pilih Tahun NKI ==</option><option value="2018">2017</option><option value="2018">2018</option> <option value="2019">2019</option> <option value="2020">2020</option> <option value="2011">2021</option><option value="2011">2022</option></select> @if($errors->has('Tahun'))<div class="text-danger">{{ $errors->first('Tahun')}}</div> @endif </div><div class="col-3"><label for="exampleFormControlSelect1">Nilai NKI</label><select class="form-control" id="exampleFormControlSelect1" name="nilai[]"><option value="">== pilih Nilai NKI ==</option><option value="P1">P1</option><option value="P2">P2</option><option value="P3">P3</option><option value="P4">P4</option><option value="P5">P5</option></select> @if($errors->has('nilai'))<div class="text-danger">{{ $errors->first('nilai')}}</div>@endif</div></div>';  
         $('.toNki').append(nki);
        }
        ...
        $('.addCuti').on('click',function(){
            Addcuti();
        });

        function Addcuti() {
            var cuti = '<div class="col-2"> <label for="exampleFormControlSelect1">Jenis Ijin</label><select class="form-control" id="exampleFormControlSelect1" name="status_ijin[]"> <option value="Cuti Dokter">Pilh jenis ijin</option><option value="Cuti Dokter">Cuti Dokter</option><option value="Rawat Inap">Rawat Inap</option></select> @if($errors->has('status_ijin')) <div class="text-danger">{{ $errors->first('status_ijin')}}</div> @endif</div> <div class="col-2"><label for="exampleFormControlSelect1">Jumlah Ijin</label><input type="text" name="nilai_ijin[]" class="form-control"id="nilai_ijin"placeholder="Nilai ijin"  value="">@if($errors->has('nilai_ijin')) <div class="text-danger">{{ $errors->first('nilai_ijin')}}</div>@endif</div>';
            $('.tocuti').append(cuti);
        }
